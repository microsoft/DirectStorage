...
void PostEffects::Render( void )
{
    ...
    // Flush resource barriers here since subsequent operations will likely also
    // transition this barrier and this triggers debug layer warnings as there's
    // a redundant barrier for g_SceneColorBuffer.
