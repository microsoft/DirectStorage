...
void Renderer::Initialize(void)
{
    ...
    std::unique_lock<std::mutex> psosLock(sm_PSOsMutex);
    ...
    s_TextureHeap.Create(L"Scene Texture Descriptors", D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV, 8192);
